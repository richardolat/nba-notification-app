...
resource "aws_iam_role" "lambda_execution" {
  name = "lambda_execution_role_nba_notification_terraformone_forproduction"  # Updated IAM role name
...
resource "aws_lambda_function" "nba_notification" {
  ...
  function_name    = "nba_notification_function_terraform_forproduction"  # Renaming the Lambda function
