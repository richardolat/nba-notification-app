...
resource "aws_iam_role" "lambda_execution" {
  name = "lambda_execution_role_nba_notification_pythondp"  # Updated IAM role name
...
resource "aws_lambda_function" "nba_notification" {
  ...
  function_name    = "nba_notification_function_pythondp"  # Renaming the Lambda function
